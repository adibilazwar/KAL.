...
# Transformasi Linear
## Definisi
Transformasi linear adalah pemetaan (fungsi) antara dua ruang vektor yang mempertahankan operasi penjumlahan dan perkalian skalar. Dengan kata lain, jika Anda memiliki dua vektor dan menjumlahkannya, lalu memetakan hasil dengan transformasi linear, hasilnya akan sama dengan memetakan masing-masing vektor secara terpisah dan kemudian menjumlahkan hasilnya.
- **Pemetaan** merupakan transformasi linear memetakan vektor dari satu ruang vektor ke ruang vektor lain. 
- **Ruang vektor** adalah kumpulan objek (vektor) yang dapat dijumlahkan dan dikalikan dengan skalar (bilangan). 
- **Keistimewaan** yaitu transformasi linear mempertahankan struktur aljabar dari ruang vektor
